...
- [next.js page router](https://nextjs.org/docs/pages)
  - [next.js app router](https://nextjs.org/docs/app/building-your-application) 는 [browser history](https://developer.mozilla.org/en-US/docs/Web/API/History)를 사용해주세요.
